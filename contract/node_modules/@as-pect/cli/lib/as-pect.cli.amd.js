        ...
        function runBinary(error, file, binary) {
            ...
            if (runTests) {
                ...
                if (runner.errors.length > 0) {
                    errors.push.apply(errors, __spreadArray([], __read(runner.errors)));
                }
                else {
                    ...
                    errors.push.apply(errors, __spreadArray([], __read(runner.errors))); // if there are any errors, add them
